      ...
      <div className=" big-info__inner items-center px-4 border-[#fed403] border ">
        <div>
          <h1 className=" max-w-xl text-2xl font-medium">
            Welcome to the kingdom of PepeKing, where memes meet crypto in a
            fusion of fun and fortune! PepeKing is not just another meme coin;
            we're on a mission to become the one true ruler of Solana's meme
            realm. PepeKing brings you endless excitement, hype on every pump,
